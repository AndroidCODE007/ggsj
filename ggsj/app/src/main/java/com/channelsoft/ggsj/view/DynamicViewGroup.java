...
//
//    public DynamicViewGroup(Context context, View targetView)
//    {
...
//    }
//
//    public DynamicViewGroup(Context context, int viewID)
//    {
//        this.mContext = context;
//        this.mInflater = ((Activity) mContext).getLayoutInflater();
...
//        ViewSwitcher.LayoutParams params = new ViewSwitcher.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
...
//
//        // init Layout params
//        RelativeLayout.LayoutParams containerParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
