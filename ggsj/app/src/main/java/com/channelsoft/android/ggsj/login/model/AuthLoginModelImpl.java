...
public class AuthLoginModelImpl implements IAuthLoginModel
{
    ...
    {
        final String url = LoginManager.getHelpDeskUrl() + Url.Login.GET_AUTH_DEVICE_INFO;
                    ...
                    public void onResponse(String s)
                    {
                        ...
                        if (listener != null)
                        {
                            try
                            {
                                ...
                                if ((Http.RETURNCODE_OK).equals(jsonObject.getString("returnCode")))
                                {
                                ...
                                else if(Http.CHANGE_TIME_OUT.equals(jsonObject.getString("returnCode")))
                                {
